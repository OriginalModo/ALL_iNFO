...
# В случае данного кода сборщик мусора сможет корректно освободить память, несмотря на циклическую ссылку, но это может
# потребовать больше времени и ресурсов. В общем, это не приведет к утечке памяти, но действительно может НЕМНОГО
# увеличить нагрузку на сборщик мусора.
