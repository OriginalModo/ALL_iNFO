...
________________________________________________________________________________________________________________________
 ...
 Спорные моменты!!!                                                            Под ВОПРОСОМ          <-----   <-----
 # В разных БД свой синтаксис НАВЕРНОЕ                                         Под ВОПРОСОМ          <-----   <-----
 ...
 # В БД Oracle Ошибки не будет!!!                                              Под ВОПРОСОМ          <-----   <-----
 SELECT author, title, price, max(amount) as maxx
 FROM book
